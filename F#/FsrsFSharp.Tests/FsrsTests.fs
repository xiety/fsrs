...
type FsrsTests () =
    ...
    member _.TestFsrs() =
        ...
        let _, actualIntervals =
            ...
            |> Array.fold (fun (card, intervals) rating ->
                let updatedCard = scheduler.ReviewCard card rating card.Interval
    ...
    member _.TestGoodLearningSteps() =
        ...
        let cardAfterGood1 = scheduler.ReviewCard card Rating.Good card.Interval
        ...
        let cardAfterGood2 = scheduler.ReviewCard cardAfterGood1 Rating.Good cardAfterGood1.Interval
